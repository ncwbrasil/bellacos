...
!(function (t, e) {
  ...
  class Y extends j {
    ...
    //FUNÇÃO PARA MUDANÇA DE SLIDE
    banner(b){
      if(b === 0 ){
        document.getElementById("bkbn").style.animation = 'fadeIn 2s';
        document.getElementById("bkbn").style.backgroundImage = "url('core/imagens/bannerb1.jpg')";
      }
      if(b == 1){
        document.getElementById("bkbn").style.animation = 'fadeIn 2s';
        document.getElementById("bkbn").style.backgroundImage = "url('core/imagens/bannerb2.jpg')";
      }
      if(b == 2){
        document.getElementById("bkbn").style.animation = 'fadeIn 2s';
        document.getElementById("bkbn").style.backgroundImage = "url('core/imagens/bannerb3.jpg')";
      }
      ...
      if (this._indicatorsElement) {
        ...
        for (let e = 0; e < i.length; e++)
          if (
            ...
            const b = parseInt(i[e].getAttribute("data-bs-slide-to"));
            this.banner(b),
